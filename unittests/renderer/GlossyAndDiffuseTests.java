   ...
   //  vTo = new Vector(0, 1, 0);
    ...
    scene.geometries.add(
            ...
            new Sphere(3, new Point(-20, 5, 3)).setEmission(new Color(255, 102, 102).reduce(2))
                    .setMaterial(new Material().setKd(0.2).setKs(1).setShininess(80).setKt(0d)),
//            new Sphere(3, new Point(-20, -8, -8)).setEmission(new Color(WHITE).reduce(6))
//                    .setMaterial(new Material().setKd(0.2).setKs(1).setShininess(80).setKt(0d)),
...
//            .setEmission(new Color(173, 216, 255))
//            .setMaterial(new Material().setKd(0.00002).setKs(1).setShininess(1).setKt(0d))
//    );
